...
int main(int argc, char* argv[]){
    ...
    LoadTextureImage("../../data/background.jpg"); // TextureImage0
    LoadTextureImage("../../data/caixa.jpg"); // TextureImage1
    LoadTextureImage("../../data/gelo.jpg"); // TextureImage2
    LoadTextureImage("../../data/indice.jpeg"); // TextureImage3
    LoadTextureImage("../../data/parede.jpg"); // TextureImage4
    LoadTextureImage("../../data/tc-earth_daymap_surface.jpg");      // TextureImage5
    LoadTextureImage("../../data/tc-earth_nightmap_citylights.gif"); // TextureImage6
    ...
    while (!glfwWindowShouldClose(window)){
        ...
        // Desenhamos o plano da parede 1
        model = Matrix_Translate(1.0f,-1.1f,-5.0f)
                *Matrix_Scale(10.0f,10.0f,1.0f)
                *Matrix_Rotate_X(-30.0);
              //* Matrix_Rotate_X(g_AngleY); //+ (float)glfwGetTime() * 0.1f);
             //       *Matrix_Rotate(1.0f, glm::vec4(1.0, 0.0, 1.0, 0.0));
